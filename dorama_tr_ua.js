(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (справжній півмісяць з зіркою)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M14 2C9.6 2 6 5.6 6 10s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6z"/>
                <path d="M16 6l-1.5 3L12 9.5l2 2L13 15l3-1.5 3 1.5-1-3.5 2-2-2.5-.5L16 6z"/>
            </svg>`,
            categories: [
                {
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (справжній тризуб)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 3L5 8l2 4-2 4 7 5 7-5-2-4 2-4-7-5z M12 6l5 4-2 3 2 3-5 4-5-4 2-3-2-3 5-4z"/>
            </svg>`,
            categories: [
                {
