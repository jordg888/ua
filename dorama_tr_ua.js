(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (дуже простий півмісяць з зіркою)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            // Максимально простий півмісяць - одне коло і зірка
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (Тризуб - ПЕРШИЙ код)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            // Використовуємо ПЕРШИЙ код тризуба
            icon: `<svg viewBox="0 0 100 150" fill="currentColor">
                <path d="M50 140 V110 M50 110 C30 110 20 90 20 60 V20 M50 110 C70 110 80 90 80 60 V20 M50 110 V30 M35 30 H65" 
                      stroke="currentColor" 
                      stroke-width="8" 
                      fill="none" 
