(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (стиль як у Dorama.js)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            // Робимо path як у Dorama.js, але формуємо півмісяць з зіркою
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 2c4.41 0 8 3.59 8 8 0 3.05-1.71 5.7-4.23 7.03-.44-.8-.7-1.72-.7-2.7 0-2.97 2.41-5.38 5.38-5.38.37 0 .73.04 1.08.11-.86-3.95-4.39-7.06-8.53-7.06z"/>
    ...
    // =========================================================================
    // 2. КОНФІГУРАЦІЯ ДЛЯ АЗІЙСЬКОГО КОНТЕНТУ (ДОРАМИ) - ТОЧНО ОРИГІНАЛ
    // =========================================================================
    var ASIAN_CONFIG = {
        'asian': {
            title: 'Дорами та Азійське',
            // ТОЧНО копіюємо оригінальний значок з dorama.js
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (стиль як у Dorama.js)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            // Робимо path як у Dorama.js, але формуємо тризуб
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L4 8l2 4-2 4 8 6 8-6-2-4 2-4-8-6z M12 5l5 4-2 3 2 3-5 4-5-4 2-3-2-3 5-4z"/>
            </svg>`,
            categories: [
                {
