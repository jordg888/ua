(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (півмісяць з зіркою)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M14 2C9.6 2 6 5.6 6 10s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8z M16 6l-1.5 3-3 .5 2 2.5-.5 4 3-1.5 3 1.5-.5-4 2-2.5-3-.5-1.5-3z"/>
            </svg>`,
            categories: [
                {
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (Тризуб - правильний)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            // Використовуємо правильний тризуб з наданого коду
            icon: `<svg viewBox="0 0 30 45" fill="currentColor">
                <path d="M15 42V32M15 32C10 32 5 28 5 18V5M15 32C20 32 25 28 25 18V5M15 32V10M10 10H20" 
                    stroke="currentColor" 
                    stroke-width="3" 
