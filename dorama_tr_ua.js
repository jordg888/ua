(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (збільшений символ)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            icon: `<svg viewBox="0 0 100 100" width="48" height="48" fill="currentColor">
                <!-- Півмісяць -->
                <path d="M65 20 A35 35 0 1 1 30 75 A40 40 0 0 0 60 25 L65 20Z" fill="currentColor"/>
                <!-- Зірка (8-кутна, як на прапорі Туреччини) -->
    ...
    var ASIAN_CONFIG = {
        'asian': {
            ...
            icon: `<svg viewBox="0 0 24 24" width="48" height="48" fill="currentColor">
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (офіційний Малий герб України)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            icon: `<svg viewBox="0 0 120 140" width="52" height="60" fill="currentColor">
                <!-- Лівий бічний зубець (трикутний) -->
                <path d="M40 40 L25 90 L40 80 L45 55 L40 40Z" fill="currentColor"/>
                <!-- Правий бічний зубець (трикутний) -->
                <path d="M80 40 L95 90 L80 80 L75 55 L80 40Z" fill="currentColor"/>
                <!-- Центральний зубець (хрестоподібний) -->
                <path d="M55 25 L50 60 L60 60 L65 25 L55 25Z" fill="currentColor"/>
                <path d="M52 50 L48 65 L58 70 L62 55 L52 50Z" fill="currentColor"/>
                <!-- Нижня основа (підкова) -->
                <path d="M35 95 L45 100 L55 105 L65 105 L75 100 L85 95 L80 110 L65 115 L55 115 L40 110 L35 95Z" fill="currentColor"/>
                <!-- Перемичка -->
                <rect x="52" y="75" width="16" height="18" fill="currentColor"/>
                <!-- Деталі зубців -->
                <circle cx="60" cy="42" r="5" fill="currentColor"/>
                <path d="M45 67 L55 70 L50 78 L42 72 L45 67Z" fill="currentColor"/>
                <path d="M75 67 L65 70 L70 78 L78 72 L75 67Z" fill="currentColor"/>
            </svg>`,
            categories: [
                {
