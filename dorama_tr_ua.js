(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (збільшений)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            icon: `<svg viewBox="0 0 178 229" width="70" height="70" fill="currentColor">
    ...
    var ASIAN_CONFIG = {
        'asian': {
            ...
            icon: `<svg viewBox="0 0 24 24" width="70" height="70" fill="currentColor">
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (той самий гарний тризуб, що був у версії 1.1.0)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            icon: `<svg viewBox="0 0 330 461" width="85" height="100" fill="currentColor">
