(function () {
    ...
    // =========================================================================
    // 1. КОНФІГУРАЦІЯ ДЛЯ ТУРЕЦЬКОГО КОНТЕНТУ (простий півмісяць)
    // =========================================================================
    var TURKISH_CONFIG = {
        'turkish': {
            title: 'Турецькі серіали',
            // Найпростіший півмісяць - два кола
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (простий тризуб)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            // Найпростіший тризуб - три лінії
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <rect x="11" y="5" width="2" height="14" fill="currentColor"/>
                <rect x="7" y="9" width="2" height="10" fill="currentColor"/>
                <rect x="15" y="9" width="2" height="10" fill="currentColor"/>
