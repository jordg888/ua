(function () {
    ...
    var TURKISH_CONFIG = {
        'turkish': {
            ...
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12.5 2C9.4 2 6.7 3.8 5.5 6.5 8.2 7.2 10.3 9.3 11 12c-.7 2.7-2.8 4.8-5.5 5.5 1.2 2.7 3.9 4.5 7 4.5 4.4 0 8-3.6 8-8s-3.6-8-8-8zm-1 4c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z"/>
    ...
    // =========================================================================
    // 3. КОНФІГУРАЦІЯ ДЛЯ УКРАЇНСЬКОГО КОНТЕНТУ (Тризуб)
    // =========================================================================
    var UKRAINIAN_CONFIG = {
        'ukrainian': {
            title: 'Українське кіно',
            icon: `<svg viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L5 8l3 4-3 4 7 6 7-6-3-4 3-4-7-6z M12 5l5 4-2 3 2 3-5 4-5-4 2-3-2-3 5-4z"/>
            </svg>`,
            categories: [
                {
